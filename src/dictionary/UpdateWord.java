...
public class UpdateWord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        update_btn.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        ...
        update_btn.setBounds(290, 270, 110, 40);
        ...
        Enterword_txt.setBounds(260, 180, 290, 40);

        jLabel3.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        jLabel3.setText("Enter Word:");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(130, 190, 130, 26);
    ...
    if (result == null) {
        int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to update the word?", "Update Word", JOptionPane.YES_NO_OPTION);

        if (dialogResult == JOptionPane.YES_OPTION) {
            // Prompt the user to enter the new meaning
            String newMeaningInput = JOptionPane.showInputDialog(null, "Enter the new meaning for the word:", "Enter New Meaning", JOptionPane.PLAIN_MESSAGE);

            if (newMeaningInput != null && !newMeaningInput.isEmpty()) {
                newMeaning = newMeaningInput;
                sb.Insert(word, newMeaningInput);
                sb.LoadDictionary();
                sb.UpdateFile();

                JOptionPane.showMessageDialog(null, "Word updated successfully.", "Update Successful", JOptionPane.INFORMATION_MESSAGE);
            } else {
                // User canceled or entered an empty string
                JOptionPane.showMessageDialog(null, "Update canceled or new meaning is empty.", "Update Canceled", JOptionPane.WARNING_MESSAGE);
            }
        }
    } else {
