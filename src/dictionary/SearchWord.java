...
public class SearchWord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        search_btn.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        ...
        search_btn.setBounds(280, 250, 110, 40);
 ...
 DictionaryNode result = sb.Search(sb.root, word);
    ...
    if (result != null) {
        // Display the meaning using a JOptionPane
        JOptionPane.showMessageDialog(null, "Meaning: " + result.meaning, "Word Found", JOptionPane.INFORMATION_MESSAGE);
    } else {
